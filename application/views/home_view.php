					...
					<div class="item active">
						...
						<div class="carousel-caption">
							...
							<p>
								...
								<br/>Conveniently drive prospective functionalities before.
							</p>
						</div>
						</img>
					</div>
						...
						<div class="col-md-12">
							<div class="featured-content-wrapper">
								...
								<div class="featured-content">
									...
									<p>
										Beribaah kerumah sang pencipta itu hal yang sangat berkesan dalam diri kita sendiri apalagi menjalankannya dengan liburan
										ke negara tetangganya yaitu turkey.
									</p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-2 col-sm-4 col-xs-6 section-margin">
							<a href="#">
								<img src="<?php echo base_url() ?>asset/img/logo-client-1.jpg" alt="Image">
							</a>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-6 section-margin">
							<a href="#">
								<img src="<?php echo base_url() ?>asset/img/logo-client-2.jpg" alt="Image">
							</a>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-6 section-margin">
							<a href="#">
								<img src="<?php echo base_url() ?>asset/img/logo-client-3.jpg" alt="Image">
							</a>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-6 section-margin">
							<a href="#">
								<img src="<?php echo base_url() ?>asset/img/logo-client-4.jpg" alt="Image">
							</a>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-6 section-margin">
							<a href="#">
								<img src="<?php echo base_url() ?>asset/img/logo-client-5.jpg" alt="Image">
							</a>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-6 section-margin">
							<a href="#">
								<img src="<?php echo base_url() ?>asset/img/logo-client-6.jpg" alt="Image">
							</a>
						</div>
					</div>
				</div>
						...
						<div class="row">
							...
							<div class="col-md-8">
								<div class="footer-text">
									<p>Assertively architect synergistic platforms vis-a-vis premium results. Synergistically facilitate high-payoff e-services
										rather than top-line sources. Collaboratively drive market positioning infomediaries without real-time e-commerce.</p>

									<ul>
										<li class="phone">
											<i class="fa fa-volume-control-phone" aria-hidden="true"></i> 1-677-124-44227
											<small>
												<i class="fa fa-clock-o" aria-hidden="true"></i> Mon - Sat 8.00 - 18.00h</small>
										</li>
										<li class="address">
											<address>
